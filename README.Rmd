...
- [`make.R`](https://github.com/mcpri3/SAMES/tree/master/make.R):
main R script to run the entire project

- [`R/`](https://github.com/mcpri3/SAMES/tree/master/R):
...
Launch the [`make.R`](https://github.com/mcpri3/SAMES/tree/master/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/mcpri3/SAMES/blob/main/CONTRIBUTING.md).
